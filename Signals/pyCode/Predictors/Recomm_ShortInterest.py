...
# Convert time_avail_m to integer if it's datetime
try:
    if signal_master['time_avail_m'].dtype in [pl.Datetime, pl.Date]:
...
# Convert time_avail_m to integer if it's datetime
try:
    if crsp['time_avail_m'].dtype in [pl.Datetime, pl.Date]:
...
# Convert time_avail_m to integer if it's datetime
try:
    if short_interest['time_avail_m'].dtype in [pl.Datetime, pl.Date]:
